...
extension HyperlinkedAPI {
  class HyperlinkDetailQuery: GraphQLQuery {
    static let operationName: String = "HyperlinkDetail"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query HyperlinkDetail($id: Int!) { hyperlinks( filters: { id: { eq: $id } } pagination: { page: { limit: 1, page: 0 } } ) { __typename nodes { __typename ...HyperlinkFields } } }"#,
    ...
    struct Data: HyperlinkedAPI.SelectionSet {
      ...
      static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        HyperlinkDetailQuery.Data.self
      ] }
      ...
      struct Hyperlinks: HyperlinkedAPI.SelectionSet {
        ...
        static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          HyperlinkDetailQuery.Data.Hyperlinks.self
        ] }
        ...
        struct Node: HyperlinkedAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            HyperlinkDetailQuery.Data.Hyperlinks.Node.self,
