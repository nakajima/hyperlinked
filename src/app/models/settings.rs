...
use crate::{app::models::kv_store, entity::hyperlink_processing_job::HyperlinkProcessingJobKind};
...
impl ArtifactCollectionSettings {
    ...
    pub fn allows_processing_job_kind(self, kind: HyperlinkProcessingJobKind) -> bool {
        match kind {
            ...
            HyperlinkProcessingJobKind::SublinkDiscovery | HyperlinkProcessingJobKind::Oembed => {
                true
            }
        }
    }
...
#[cfg(test)]
#[path = "../../../tests/unit/app_models_settings.rs"]
mod tests;
